...
import com.aem.exadel.entity.HeroTextBean;
...
public class HeroRestComponent extends WCMUsePojo {
    ...
    public void activate() throws Exception {
        ...
        Distance dd =  new Distance(); //r.getRows()[0].getElements()[0].getDistance();
        Duration du =  new Duration();//r.getRows()[0].getElements()[0].getDuration();
        dd.setText("text");
        dd.setValue("value");
